    ...
    <div className="text-white">
      ...
      <div className="flex gap-x-8 lg:gap-x-10 my-8 justify-center">
        <a
          ...
          className="grid place-items-center text-xl  lg:text-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full p-2 border-4 border-transparent hover:border-white transition-all"
        >
          <FaGithub />
        </a>
        <a
